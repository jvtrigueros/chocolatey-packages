...
$packageName = 'soundnode-app' # arbitrary name for the package, used in messages
$registryUninstallerKeyName = 'soundnode-app' #ensure this is the value in the registry
